...
G4ThreadLocal G4Allocator<QuLGTrajectory>* QuLGTrajectoryAllocator = nullptr;
...
QuLGTrajectory::QuLGTrajectory(const G4Track* aTrack)
...
QuLGTrajectory::QuLGTrajectory(QuLGTrajectory &right)
...
void QuLGTrajectory::DrawTrajectory() const
{
