#ifndef QuLGEventAction_h
#define QuLGEventAction_h 1
...
class QuLGEventAction : public G4UserEventAction
{
  public:

    QuLGEventAction(const QuLGDetectorConstruction*);
    virtual ~QuLGEventAction();
  ...
  private:
    ...
    QuLGEventMessenger* fEventMessenger;
