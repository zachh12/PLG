...
#ifndef QuLGUserTrackInformation_h
#define QuLGUserTrackInformation_h 1

enum QuLGTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,
...
class QuLGUserTrackInformation : public G4VUserTrackInformation
{
  public:

    QuLGUserTrackInformation();
    virtual ~QuLGUserTrackInformation();
