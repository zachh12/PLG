...
#ifndef HexLGUserTrackInformation_h
#define HexLGUserTrackInformation_h 1

enum HexLGTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,
...
class HexLGUserTrackInformation : public G4VUserTrackInformation
{
  public:

    HexLGUserTrackInformation();
    virtual ~HexLGUserTrackInformation();
